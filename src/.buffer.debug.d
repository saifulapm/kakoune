src/buffer.debug.o: src/buffer.cc src/buffer.hh src/clock.hh \
  ...
  src/coord.hh src/units.hh src/assert.hh src/hash.hh \
  ...
  src/selection.hh src/utf8_iterator.hh src/hook_manager.hh \
  src/completion.hh \
  ...
  src/ranked_match.hh src/option_manager.hh src/option_types.hh \
  ...
  src/input_handler.hh src/context.hh src/normal.hh src/keys.hh \
  src/diff.hh src/unit_tests.hh src/window.hh src/highlighter_group.hh \
  src/highlighter.hh src/parameters_parser.hh
src/buffer.hh:
src/clock.hh:
/Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX.sdk/usr/include/c++/v1/chrono:
/Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX.sdk/usr/include/c++/v1/__config:
