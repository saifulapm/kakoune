src/client.debug.o: src/client.cc src/client.hh src/array.hh \
  ...
  src/display_buffer.hh src/face.hh src/color.hh src/exception.hh \
  ...
  src/assert.hh src/meta.hh src/hash.hh \
  ...
  src/units.hh src/utf8.hh src/unicode.hh src/flags.hh src/coord.hh \
  src/range.hh src/vector.hh \
  ...
  src/env_vars.hh src/event_manager.hh src/utils.hh src/optional.hh \
  src/function.hh \
  ...
  src/context.hh src/selection.hh src/safe_ptr.hh src/ref_ptr.hh \
  src/enum.hh src/normal.hh src/keys.hh src/unique_ptr.hh src/option.hh \
  src/buffer_utils.hh src/buffer.hh src/file.hh \
  ...
  src/scope.hh src/shared_string.hh src/value.hh src/buffer.inl.hh \
  src/utf8_iterator.hh src/debug.hh src/remote.hh src/option_types.hh \
  src/string_utils.hh src/format.hh src/ranges.hh \
  ...
  src/client_manager.hh src/hook_manager.hh src/keymap_manager.hh \
  src/option_manager.hh src/shell_manager.hh src/unique_descriptor.hh \
  ...
  src/face_registry.hh src/command_manager.hh src/parameters_parser.hh \
  src/user_interface.hh src/window.hh src/highlighter_group.hh \
  src/highlighter.hh
src/client.hh:
src/array.hh:
/Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX.sdk/usr/include/c++/v1/utility:
