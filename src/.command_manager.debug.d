src/command_manager.debug.o: src/command_manager.cc \
  src/command_manager.hh src/completion.hh \
  ...
  src/ranked_match.hh src/shell_manager.hh src/env_vars.hh \
  src/hash_map.hh src/utils.hh src/unique_descriptor.hh \
  ...
  src/parameters_parser.hh src/exception.hh src/optional.hh \
  src/format.hh src/function.hh src/alias_registry.hh src/safe_ptr.hh \
  src/ref_ptr.hh src/ranges.hh \
  ...
  src/array.hh src/context.hh src/selection.hh src/coord.hh src/range.hh \
  src/debug.hh src/enum.hh src/flags.hh src/file.hh \
  ...
  src/hook_manager.hh src/unique_ptr.hh src/option_manager.hh \
  src/option.hh src/option_types.hh src/string_utils.hh src/profile.hh \
  src/clock.hh \
  ...
  src/register_manager.hh src/scope.hh src/unit_tests.hh
