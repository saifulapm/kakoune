src/commands.debug.o: src/commands.cc src/commands.hh \
  src/alias_registry.hh src/safe_ptr.hh src/assert.hh src/ref_ptr.hh \
  src/string.hh src/memory.hh \
  ...
  src/units.hh src/utf8.hh src/unicode.hh \
  ...
  src/array.hh src/hash_map.hh src/vector.hh \
  ...
  src/coord.hh src/enum.hh src/file.hh src/exception.hh src/utils.hh \
  ...
  src/flags.hh src/optional.hh src/option.hh src/range.hh src/scope.hh \
  src/unique_ptr.hh src/shared_string.hh src/value.hh src/buffer.inl.hh \
  src/buffer_manager.hh src/buffer_utils.hh src/selection.hh \
  src/utf8_iterator.hh src/client.hh src/display_buffer.hh src/face.hh \
  src/color.hh src/env_vars.hh src/event_manager.hh src/function.hh \
  ...
  src/input_handler.hh src/completion.hh src/ranked_match.hh \
  src/context.hh src/normal.hh src/keys.hh src/client_manager.hh \
  src/command_manager.hh src/shell_manager.hh src/unique_descriptor.hh \
  ...
  src/parameters_parser.hh src/format.hh src/debug.hh \
  src/face_registry.hh src/hook_manager.hh src/highlighter.hh \
  src/highlighters.hh src/insert_completer.hh src/keymap_manager.hh \
  src/option_manager.hh src/option_types.hh src/string_utils.hh \
  src/profile.hh src/regex.hh src/regex_vm.hh \
  ...
  src/register_manager.hh src/remote.hh src/language_registry.hh \
  src/tree_sitter.hh src/tree_sitter/api.h \
  ...
  src/syntax_tree.hh src/user_interface.hh src/window.hh \
