src/context.debug.o: src/context.cc src/context.hh src/selection.hh \
  ...
  src/range.hh src/safe_ptr.hh src/ref_ptr.hh src/utils.hh src/string.hh \
  src/memory.hh \
  ...
  src/meta.hh src/utf8.hh src/unicode.hh \
  ...
  src/optional.hh src/function.hh src/exception.hh src/client.hh \
  src/array.hh src/clock.hh \
  ...
  src/input_handler.hh src/completion.hh src/ranked_match.hh src/enum.hh \
  src/normal.hh src/keys.hh src/unique_ptr.hh src/option.hh \
  src/user_interface.hh src/scope.hh src/buffer_manager.hh src/buffer.hh \
  src/file.hh \
  ...
  src/register_manager.hh src/hook_manager.hh src/face_registry.hh \
  src/ranges.hh \
  ...
  src/parameters_parser.hh src/format.hh
src/context.hh:
src/selection.hh:
src/coord.hh:
src/units.hh:
