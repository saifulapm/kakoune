src/highlighters.opt.o: src/highlighters.cc src/highlighters.hh \
  src/color.hh src/exception.hh src/string.hh src/memory.hh \
  ...
  src/highlighter.hh src/coord.hh src/completion.hh \
  ...
  src/ranked_match.hh src/range.hh src/hash_map.hh src/utils.hh \
  src/parameters_parser.hh src/optional.hh src/format.hh src/function.hh \
  src/unique_ptr.hh src/option.hh src/buffer_utils.hh src/buffer.hh \
  src/clock.hh \
  ...
  src/highlighter_group.hh src/language_registry.hh src/regex.hh \
  src/regex_vm.hh \
  ...
  src/string_utils.hh src/register_manager.hh src/syntax_tree.hh \
  src/window.hh
src/highlighters.hh:
src/color.hh:
src/exception.hh:
