src/hook_manager.debug.o: src/hook_manager.cc src/hook_manager.hh \
  src/completion.hh \
  ...
  src/ranked_match.hh src/safe_ptr.hh src/ref_ptr.hh src/enum.hh \
  src/array.hh src/unique_ptr.hh src/debug.hh src/command_manager.hh \
  src/shell_manager.hh src/env_vars.hh src/hash_map.hh src/utils.hh \
  ...
  src/format.hh src/function.hh src/context.hh src/selection.hh \
  src/coord.hh src/range.hh src/display_buffer.hh src/face.hh \
  src/color.hh src/flags.hh src/face_registry.hh src/ranges.hh \
  ...
  src/option_manager.hh src/option.hh src/option_types.hh \
  src/string_utils.hh src/profile.hh src/clock.hh \
