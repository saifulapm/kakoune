src/input_handler.debug.o: src/input_handler.cc src/input_handler.hh \
  src/completion.hh \
  ...
  src/units.hh src/assert.hh src/hash.hh \
  ...
  src/meta.hh src/utf8.hh src/unicode.hh src/array_view.hh \
  ...
  src/ranked_match.hh src/array.hh src/context.hh src/selection.hh \
  src/coord.hh src/range.hh src/safe_ptr.hh src/ref_ptr.hh src/utils.hh \
  src/optional.hh src/function.hh src/exception.hh src/env_vars.hh \
  src/hash_map.hh src/enum.hh src/face.hh src/color.hh src/flags.hh \
  src/normal.hh src/keys.hh src/display_buffer.hh src/buffer.hh \
  src/clock.hh \
  ...
  src/option.hh src/scope.hh src/unique_ptr.hh src/shared_string.hh \
  src/value.hh src/buffer.inl.hh src/debug.hh src/command_manager.hh \
  ...
  src/parameters_parser.hh src/format.hh src/client.hh \
  ...
  src/hook_manager.hh src/face_registry.hh src/ranges.hh \
  ...
  src/string_utils.hh src/insert_completer.hh src/regex.hh \
  src/regex_vm.hh \
  ...
  src/register_manager.hh src/user_interface.hh src/window.hh \
  src/highlighter_group.hh src/highlighter.hh src/word_db.hh
