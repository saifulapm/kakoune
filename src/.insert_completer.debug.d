src/insert_completer.debug.o: src/insert_completer.cc \
  src/insert_completer.hh src/option.hh src/exception.hh src/string.hh \
  src/memory.hh \
  ...
  src/display_buffer.hh src/face.hh src/color.hh src/flags.hh \
  src/coord.hh src/range.hh src/hash_map.hh \
  ...
  src/utils.hh src/optional.hh src/buffer_manager.hh src/buffer.hh \
  src/clock.hh \
  ...
  src/array.hh src/enum.hh src/file.hh \
  ...
  src/shared_string.hh src/value.hh src/buffer.inl.hh \
  src/buffer_utils.hh src/selection.hh src/utf8_iterator.hh src/debug.hh \
  src/command_manager.hh src/completion.hh src/ranked_match.hh \
  ...
  src/parameters_parser.hh src/format.hh src/function.hh src/changes.hh \
  src/context.hh src/client.hh src/event_manager.hh \
  /Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX.sdk/usr/include/c++/v1/csignal \
  src/input_handler.hh src/normal.hh src/keys.hh src/face_registry.hh \
  src/ranges.hh \
  ...
  src/hook_manager.hh src/option_manager.hh src/option_types.hh \
  ...
  src/window.hh src/highlighter_group.hh src/highlighter.hh \
  src/word_db.hh src/word_splitter.hh src/user_interface.hh
