src/language_registry.opt.o: src/language_registry.cc \
  src/language_registry.hh src/hash_map.hh src/hash.hh \
  ...
  src/string.hh src/units.hh src/utf8.hh src/unicode.hh \
  src/array_view.hh \
  ...
  src/unique_ptr.hh src/utils.hh src/optional.hh src/regex.hh \
  src/regex_vm.hh src/exception.hh src/flags.hh \
  ...
  src/ref_ptr.hh src/tree_sitter.hh src/tree_sitter/api.h \
  ...
  src/option.hh src/range.hh src/safe_ptr.hh src/scope.hh \
  src/shared_string.hh src/value.hh src/buffer.inl.hh src/debug.hh \
  src/format.hh \
