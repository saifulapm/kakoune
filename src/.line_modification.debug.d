src/line_modification.debug.o: src/line_modification.cc \
  src/line_modification.hh src/array_view.hh \
  ...
  src/utils.hh src/range.hh src/vector.hh src/memory.hh \
  ...
  src/coord.hh src/array.hh src/enum.hh src/string.hh src/utf8.hh \
  src/unicode.hh src/file.hh src/exception.hh \
  ...
  src/flags.hh src/optional.hh src/option.hh src/safe_ptr.hh \
  src/ref_ptr.hh src/scope.hh src/unique_ptr.hh src/shared_string.hh \
  src/hash_map.hh src/value.hh src/buffer.inl.hh src/unit_tests.hh \
  src/ranges.hh \
