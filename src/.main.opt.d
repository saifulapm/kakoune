src/main.opt.o: src/main.cc src/assert.hh src/backtrace.hh src/buffer.hh \
  src/clock.hh \
  ...
  src/coord.hh src/units.hh src/hash.hh \
  ...
  src/array.hh src/array_view.hh \
  ...
  src/enum.hh src/string.hh src/memory.hh \
  ...
  src/meta.hh src/utf8.hh src/unicode.hh src/file.hh src/exception.hh \
  src/utils.hh \
  ...
  src/flags.hh src/optional.hh src/option.hh src/vector.hh \
  ...
  src/range.hh src/safe_ptr.hh src/ref_ptr.hh src/scope.hh \
  src/unique_ptr.hh src/shared_string.hh src/hash_map.hh src/value.hh \
  src/buffer.inl.hh src/buffer_utils.hh src/selection.hh \
  src/utf8_iterator.hh src/buffer_manager.hh src/client_manager.hh \
  src/client.hh src/display_buffer.hh src/face.hh src/color.hh \
  ...
  src/env_vars.hh src/event_manager.hh src/function.hh \
  ...
  src/context.hh src/normal.hh src/keys.hh src/command_manager.hh \
  src/shell_manager.hh src/unique_descriptor.hh \
  ...
  src/parameters_parser.hh src/format.hh src/commands.hh src/debug.hh \
  ...
  src/keymap_manager.hh src/language_registry.hh src/regex.hh \
  src/regex_vm.hh \
  ...
  src/profile.hh src/register_manager.hh src/remote.hh src/unit_tests.hh \
