src/normal.debug.o: src/normal.cc src/normal.hh src/optional.hh \
  src/assert.hh \
  ...
  src/keys.hh src/coord.hh src/units.hh src/hash.hh \
  ...
  src/flags.hh src/meta.hh src/unicode.hh \
  ...
  src/string.hh src/utf8.hh src/exception.hh src/buffer.hh src/clock.hh \
  ...
  src/array.hh src/enum.hh src/file.hh src/utils.hh \
  ...
  src/option.hh src/range.hh src/safe_ptr.hh src/ref_ptr.hh src/scope.hh \
  src/unique_ptr.hh src/shared_string.hh src/hash_map.hh src/value.hh \
  src/buffer.inl.hh src/buffer_manager.hh src/buffer_utils.hh \
  src/selection.hh src/utf8_iterator.hh src/changes.hh src/client.hh \
  src/display_buffer.hh src/face.hh src/color.hh \
  ...
  src/context.hh src/command_manager.hh src/shell_manager.hh \
  ...
  src/parameters_parser.hh src/format.hh src/diff.hh \
  ...
  src/keymap_manager.hh src/option_manager.hh src/option_types.hh \
  ...
  src/register_manager.hh src/selectors.hh src/user_interface.hh \
  src/unit_tests.hh src/window.hh src/highlighter_group.hh \
  src/highlighter.hh src/word_db.hh
src/normal.hh:
src/optional.hh:
src/assert.hh:
/Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX.sdk/usr/include/c++/v1/utility:
