src/remote.debug.o: src/remote.cc src/remote.hh src/env_vars.hh \
  src/hash_map.hh src/hash.hh \
  ...
  src/assert.hh src/meta.hh src/vector.hh \
  ...
  src/exception.hh src/string.hh src/units.hh src/utf8.hh src/unicode.hh \
  src/array_view.hh \
  ...
  src/utils.hh src/optional.hh src/unique_ptr.hh src/buffer_utils.hh \
  ...
  src/coord.hh src/array.hh src/enum.hh src/file.hh \
  ...
  src/flags.hh src/option.hh src/range.hh src/safe_ptr.hh src/ref_ptr.hh \
  src/scope.hh src/shared_string.hh src/value.hh src/buffer.inl.hh \
  src/selection.hh src/utf8_iterator.hh src/debug.hh \
  src/client_manager.hh src/client.hh src/display_buffer.hh src/face.hh \
  src/color.hh \
  ...
  src/event_manager.hh src/function.hh \
  ...
  src/parameters_parser.hh src/format.hh src/user_interface.hh \
  src/ranges.hh \
