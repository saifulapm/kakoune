src/scope.debug.o: src/scope.cc src/scope.hh src/unique_ptr.hh \
  ...
  src/utils.hh src/assert.hh src/alias_registry.hh src/safe_ptr.hh \
  src/ref_ptr.hh src/string.hh src/memory.hh \
  ...
  src/meta.hh src/hash.hh src/units.hh src/utf8.hh src/unicode.hh \
  ...
  src/face_registry.hh src/face.hh src/color.hh src/exception.hh \
  src/flags.hh src/highlighter_group.hh src/highlighter.hh src/coord.hh \
  src/completion.hh src/ranked_match.hh src/range.hh \
  src/parameters_parser.hh src/optional.hh src/format.hh src/function.hh \
  src/hook_manager.hh src/enum.hh src/keymap_manager.hh src/keys.hh \
  src/option_manager.hh src/option.hh src/option_types.hh \
  src/string_utils.hh src/context.hh src/selection.hh
src/scope.hh:
src/unique_ptr.hh:
/Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX.sdk/usr/include/c++/v1/utility:
/Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX.sdk/usr/include/c++/v1/__config:
