src/shell_manager.debug.o: src/shell_manager.cc src/shell_manager.hh \
  src/array_view.hh \
  ...
  src/env_vars.hh src/hash_map.hh src/hash.hh \
  ...
  src/string.hh src/units.hh src/utf8.hh src/unicode.hh src/utils.hh \
  src/unique_descriptor.hh src/completion.hh \
  ...
  src/debug.hh src/array.hh src/enum.hh src/client.hh src/clock.hh \
  ...
  src/flags.hh src/coord.hh src/range.hh src/event_manager.hh \
  src/optional.hh src/function.hh \
  /Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX.sdk/usr/include/c++/v1/csignal \
  src/input_handler.hh src/context.hh src/selection.hh src/safe_ptr.hh \
  src/ref_ptr.hh src/normal.hh src/keys.hh src/unique_ptr.hh \
  src/option.hh src/command_manager.hh src/parameters_parser.hh \
  src/format.hh src/face_registry.hh src/ranges.hh \
