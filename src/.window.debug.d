src/window.debug.o: src/window.cc src/window.hh src/display_buffer.hh \
  src/face.hh src/color.hh src/exception.hh src/string.hh src/memory.hh \
  ...
  src/flags.hh src/coord.hh src/range.hh src/vector.hh \
  ...
  src/highlighter_group.hh src/highlighter.hh src/completion.hh \
  src/ranked_match.hh src/utils.hh src/parameters_parser.hh \
  src/optional.hh src/format.hh src/function.hh src/unique_ptr.hh \
  src/safe_ptr.hh src/ref_ptr.hh src/option.hh src/selection.hh \
  src/scope.hh src/buffer.hh src/clock.hh \
  ...
  src/buffer_utils.hh src/utf8_iterator.hh src/context.hh src/client.hh \
  src/env_vars.hh src/event_manager.hh \
  ...
  src/input_handler.hh src/normal.hh src/keys.hh src/hook_manager.hh \
